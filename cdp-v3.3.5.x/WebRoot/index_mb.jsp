...
<div id="mbLogin-con" class="mbLogin-con">
     <div id="msg" class="mbLogin-line"></div>
 	 <div id="cmpy" class="mbLogin-line mbLogin-cmpy"><input id="CMPY_CODE" name="CMPY_CODE" type="text" class="ipt-t" value="ruaho"/><input id="CMPY_CODE__NAME" name="CMPY_CODE__NAME" type="text" class="ipt-t icon-input-cmpy" value='ruaho' size=30/><span class="dict-cmpy"></span></div>
