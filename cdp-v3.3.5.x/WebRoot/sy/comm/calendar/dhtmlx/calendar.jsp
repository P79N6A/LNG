...
<script>
	...
	/*公共_初始化页面高度-开始*/
		if(!parent.System.getTempParams(MB.serv) || !parent.System.getTempParams(MB.serv).initHeight)
			parent.System.setTempParams(MB.serv, {"initHeight":parent.jQuery("#" + MB.serv + "-show-do-tabFrame").height()});
		var initHeight = parent.System.getTempParams(MB.serv).initHeight;
	...
	//公共_开始初始化scheduler
	scheduler.init('right_scheduler',null,"week");
	/*公共_迷你日历控件挂载-开始*/
