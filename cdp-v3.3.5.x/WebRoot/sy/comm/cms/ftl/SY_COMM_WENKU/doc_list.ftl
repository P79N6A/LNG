...
<head>
	...
	<style type="text/css">
		...
		.unknown .txt {
            ...
            height: 18px;
            width: 24px;
            background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -879px transparent;
        }
		.doc {
			position:absolute;
				right:6px;
            ...
            height: 18px;           
            width: 24px;           
            background:url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 1px transparent;
            } .docx {
            	position:absolute;
				right:6px;
				bottom:8px;
                ...
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -79px transparent;
            } .pptx {
            	position:absolute;
				right:6px;
				bottom:8px;
                ...
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -159px transparent;
            } .xlsx {
            	position:absolute;
				right:6px;
				bottom:8px;
                ...
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -239px transparent;
            } .pot {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -319px transparent;
            } .pps {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -399px transparent;
            } .rtf {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -479px transparent;
            } .wps {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -559px transparent;
            } .et {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -639px transparent;
            } .dps {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -719px transparent;
            } .pdf {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -799px transparent;
            }.epub {
            	position:absolute;
				right:6px;
				bottom:8px;
                height: 18px;
                width: 24px;
                background: url("/sy/comm/wenku/img/b.png") no-repeat scroll 0 -959px transparent;
            }
	</style>
	<script type="text/javascript">	
		...
		function doPage(page){
			window.location = "/wenku/doclist/" + "${channel.LIST_ID}" + "/index_"+page+".html";
		}
...
<body>
	<@coms_html comsId="${coms_nav_id}" siteId="${chanel.SITE_ID}" comparam="{'titleBar':'portal-title-none'}">
		${coms.AREA}
	</@coms_html>
	<div class="w101"></div>
	<table border="0" cellpadding="4" cellspacing="0" width="100%" class="top">
		<tr>
			<td colspan="2"><h2>文辑：${channel.LIST_TITLE!''}</h2>&nbsp;&nbsp;
			<font color="#aaa">所有者：${(channel.S_UNAME)!(channel.S_USER)!''}</font></td>
		</tr>
		<tr>
					...
					<tr>
						<td rowspan="3" width="100" height="170" align="center">
							<a href="javascript:doView('${doc.DOCUMENT_ID}', '${doc.DOCUMENT_TITLE}');">
								...
								<b class="unkonwn ${doc.DOCUMENT_FILE_SUFFIX!'txt'}"></b>
							</a>
						</td>
						<td>
