...
<script type="text/javascript">
	...
	function doPage(page){
		window.location = "/bbs/channel/" + "${chanel.CHNL_ID}" + "/index_"+page+".html?group=${group}";
	}
	function publish(){
		var url = "/bbs/tmpl/${publish_tmpl_id}.html?CHNL_ID=${CHNL_ID}&SITE_ID=${chanel.SITE_ID}";			
    ...
    <div id="content" class="clearfix">
        <div id="main">
            ...
            <div class="bbs_fath">
                <h2>
                	<span class="left">
                		<img alt="${channel.CHNL_NAME}" src="/sy/comm/bbs/img/bbs_ico_normal_new.png" />
						<span class="title">
							${channel.CHNL_NAME}
						</span>
					</span>
					<#assign zhuti=0,huitie=0 />
					<span class="amount index${channel_index}">${zhuti}主题，${huitie}回帖</span>
				</h2>
                <div class="con">
                	<@channel_list debugName="${channel.CHNL_NAME}" channelId="${channel.CHNL_ID}">
					<#list tag_list as channel2>
					
					<#if channel2.CHNL_ID=chanel.CHNL_ID>
