...
<script type="text/javascript">
	function topicView(id,name){
		var url = "/bbs/content/" + id + ".html?group=true";	
...
<div class='portal-box ${boxTheme!""}' style='min-height:200px;background:white;'>
	<div class='portal-box-title'>
		...
		<span class="more" onclick="window.location='/sy/comm/page/SY_COMM_TEMPL.show.do?model=view&pkCode=0pAYRkSkh5aUCHguWrN55m&$SITE_ID$=${SITE_ID!}'">查看更多&gt;&gt;</span>
	</div>
