<script type="text/javascript">
	function doChannel(id,name){
		window.location = "/bbs/channel/" + id + "/index_1.html?group=true";	
	}
...
<div class='portal-box ${boxTheme!""}' style='min-height:200px;'>
	<div class='portal-box-title'>
		...
		<span class="more" onclick="window.location = '/bbs/channel/${channel.CHNL_ID}/index_1.html?group=true'">查看更多&gt;&gt;</span>
	</div>
