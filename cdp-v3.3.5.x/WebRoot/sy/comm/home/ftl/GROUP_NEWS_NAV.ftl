...
<div class='portal-box ${boxTheme!""}' style='min-height:0px;'>
	...
	<div class='portal-box-con' style='height:${height};'>
		<div id="menu1" class="menu">
			<ul>
				<li>
					<a href="/sy/comm/page/SY_COMM_TEMPL.show.do?model=view&pkCode=1bRguovI51MoLpHXXLdrg5&$SITE_ID$=${SITE_ID!''}">新闻首页</a>
				</li>
				<#list _DATA_ as channel>
				<li>
					 <a href="/news/channel/${channel.CHNL_ID}/index.html?group=true">
						${channel.CHNL_NAME}
					 </a>
				</li>
				</#list>
