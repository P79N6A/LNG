...
<div id='SY_COMM_MEMO_PAD' style='float: left;width: 100%; height: 530px;background: url(sy/comm/desk/css/images/rh-back/desk_42.jpg)'>
	<style type="text/css">
		...
		.pad-textarea-top-time{width: 12%;height: 100%;float: right;margin-right: 2%;}
	...
	<div id="pad_List" style="height: 495px; width: 25%; float:left;margin-left: 1.3%;margin-top: 1.5%;background-color: white;box-shadow: 4px 2px 4px rgb(32, 32, 32);">
	...
	<div id="pad_info" style="height: 495px;float: right; margin-right: 1.3%; width: 71%;margin-top: 1.5%;box-shadow: 2px 2px 15px rgb(0, 0, 0);">
		<div class="pad-top">
		...
		<div style="width: 100%;height: 8%;background: #eee7b0;">
			<div style="width: 5%;height: 100%;margin-top: -1px;float: left;border-bottom: solid #C7C7C7 1px;">
		...
		<div class="pad-textarea">
			<div style="width:5%;height:100%;background: url(/sy/comm/pad/list.png);float: left;border-bottom: solid #CCCCCC 1px;margin-bottom: -1px;">
...
<script type="text/javascript">
	...
	var editor = createEditor("pad_text");
	<#--编辑器添加改变事件-->
	...
	function  allLi(){
		jQuery("#memoUL li").unbind("click").bind("click",function(){
			...
			var clickLiValue = jQuery(this).find(".memoTextHid").val();
			if(clickLiValue){
