...
<#if existCurOdeptMind=true>
	<div class="mindODeptTable" id='mind${userBean.ODEPT_CODE}' deptCode='${userBean.ODEPT_CODE}' border="0">
		...
		<span class='left mindSortClick <#if sortType="TYPE" >mindTypeSelected</#if>' deptCode='${userBean.ODEPT_CODE}' sortType="TYPE" style='cursor:pointer'>按类别排序</span>
        <span class='left'>&nbsp;&nbsp;</span>
		<span class='left mindSortClick <#if sortType="TIME" >mindTypeSelected</#if>' deptCode='${userBean.ODEPT_CODE}' sortType="TIME" style='cursor:pointer'>按时间排序</span>
	</div>
...
<#list odeptList as odept>
	<#if odept.DEPT_CODE != userBean.ODEPT_CODE >
		<div class="mindODeptTable fl" id='mind${odept.DEPT_CODE}' deptCode='${odept.DEPT_CODE}' border="0">
			...
			<span class='left mindSortClick' sortType="TYPE" deptCode='${odept.DEPT_CODE}' style='cursor:pointer'>按类别排序</span>
	        <span class='left'>&nbsp;&nbsp;</span>
			<span class='left mindSortClick' sortType="TIME" deptCode='${odept.DEPT_CODE}' style='cursor:pointer'>按时间排序</span>
		</div>
