...
function openPdfFile(){
	TANGER_OCX_OBJ.AddDocTypePlugin(".pdf","PDF.NtkoDocument","4.0.0.0","/ms_office/NTKOOleDocAll.dll",51,true);
...
function loadFile(ProgId){
	...
	if(_officeParam.isLocalFile){
		...
		if(ProgId){
			TANGER_OCX_OBJ.OpenFromURL(_officeParam.httpUrl,readonly,ProgId);
		}else{
