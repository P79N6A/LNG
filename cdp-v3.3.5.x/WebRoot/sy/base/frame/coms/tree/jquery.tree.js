...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        ...
        function buildnode(nd, ht, deep, path, isend, no_check) {
            ...
            //checkbox
            if (dfop.showcheck == true && !no_check) {
            	if(!nd.showcheck) {
            		if (nd.CHILD) {
            ...
            ht.push("<span unselectable='on'>", nd.NAME, "</span>");
            ht.push("</a>");
            ht.push("</div>");
            //Child
            if (nd.CHILD) {
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
				...
				if($(et).is("div") && $(et).has("img.bbit-tree-node-cb")){
