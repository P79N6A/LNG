...
<div id="tabs" class="rhCard-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
	...
	<div id="tabs-1" class="ui-form-default">
		...
		<tr>
			<td class="tl">普通意见</td>
			<td align="left">
			<input type="text" id="MIND_CODE__NAME" class="wp50" readonly value="" >
		...
		<tr>
			<td class="tl">固定意见</td>
			<td align="left">
			<input type="text" class="wp50" id="MIND_REGULAR__NAME" name="MIND_REGULAR__NAME"  value="">
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="wp50" id="MIND_TERMINAL__NAME" value="">
	...
	<div id="tabs-4" class="ui-form-default">
		...
		<tr>
			...
			<a href="#" onclick="openFieldControlDialog('GROUP_DISPLAY',' and ITEM_INPUT_TYPE=10')">选择</a>
		...
		<tr>
			...
			<a href="#" onclick="openFieldControlDialog('GROUP_HIDE',' and ITEM_INPUT_TYPE=10')">选择</a>
		...
		<tr>
			...
			<a href="#" onclick="openFieldControlDialog('GROUP_EXPAND',' and ITEM_INPUT_TYPE=10')">选择</a> 
		...
		<tr>
			...
			<a href="#" onclick="openFieldControlDialog('GROUP_COLLAPSE',' and ITEM_INPUT_TYPE=10')">选择</a>
	...
	<div id="tabs-5" class="ui-form-default">
		...
		<div id="fileTypeControl">
		    <table cellSpacing=1 cellPadding=0 id='fileTypeSelect' class='list_table'>
		    	<thead><tr class='topTr'><td>文件类型</td><td>查看</td><td>编辑</td><td>添加</td><td >删除</td></tr></thead>
		    </table>
		</div>
