...
function innerOpenNodeDefDlg(node){
	...
	var rtnObj = window.showModalDialog(dialogPage,nodeObj,"dialogWidth:800px;dialogHeight:500px;center:yes;resizable:yes;status=no");
...
function innerOpenLineDefDlg(lineDef){
	...
	var rtnObj = window.showModalDialog("line.jsp",lineObj,"dialogWidth:600px;dialogHeight:500px;center:yes;resizable:yes;status=no");
